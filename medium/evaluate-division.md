...
This is a straightforward shortest-paths problem on bidirectional graphs. A BFS or DFS for each query suffices. The code here is slightly sped up using a cache.
